...
async function sendToGroqAPI(base64Image) {
    ...
    const prompt = "Analyze this scene through the AR glasses camera. Provide a concise, conversational description of what's happening, who or what is visible, their expressions/appearance/posture, notable objects, the environment, and any interesting details. Format it as natural observations that could help someone start a relevant conversation about what they're seeing.";
